...
function setup() {
    ...
    canvas.parent("p5-canvas-container"); // Set canvas parent after create canvas so that it can be displayed in GitHub later
    ...
    planets.push({ x: 200, y: 300, size: 70, color: [100, 255, 100] });
    planets.push({ x: 400, y: 200, size: 80, color: [100, 100, 255] });
